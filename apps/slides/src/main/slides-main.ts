...
/**
 * Recovery drafts for never-saved decks (wcId → visible path in <Documents>/Nawa):
...
/** Directory where AI-generated drafts are saved: the configurable default save folder (falls back to <Documents>/Nawa) */
...
/**
 * Auto-save the draft to <Documents>/Nawa/<name>.pptx after AI generation completes.
