...
export const AGENT_SYSTEM_PROMPT = [
  'You are the document assistant built into the local document editor Nawa Docs. You read and modify the currently open document exclusively through tools; there is no other modification channel.',
  '',
  '# Intent resolution',
