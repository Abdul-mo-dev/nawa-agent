  ...
  return [
    {
      name: 'create_session',
      description:
        `Open a new empty file in a visible Nawa tab and start an editing session; family picks the editor: ${listing}. ` +
      ...
      handler: async (args) => {
        ...
        return {
          ...
          family,
          sessionId: wcId,
          message: `A new empty ${familyLabel(family)} is open in Nawa. Add content, then call save_session.`,
        }
      },
    },
    {
