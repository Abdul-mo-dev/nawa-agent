...
export const strings = {
  zh: {
    ...
    cloudSubtitle: '在网页端用云端 AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录云端账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    intgStep1Update: 'Nawa 升级带来新版 skill 时，对应助手旁会出现「更新」按钮。',
    ...
    intgOtherFolderDesc: '选择它的 skills 目录，Nawa 把文件写进去。',
    ...
    intgExample3: '把 budget.xlsx 转成 PDF，并在 Nawa 里打开',
    intgStep2Note: '助手会自己调用 Nawa 命令行，你不需要输入任何命令。',
    intgCliPartTitle: 'CLI · 命令行 + skill',
    intgCliPartDesc:
      '适合能运行终端命令的助手（Claude Code、Codex、Cursor 等）。安装 skill 后，助手会自己调用 Nawa 命令行创建、转换、读取和编辑文件，你不需要输入任何命令。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助手调用外部工具的通用协议。助手不能运行命令（如 Claude Desktop），或你想让它直接操作 Nawa 窗口时用这条路。下面两种接法任选一种。',
    intgMcpStdioTitle: '由助手启动（推荐）',
    intgMcpStdioDesc:
      '助手自己拉起 Nawa mcp，不需要在这里开任何开关，Nawa 也不用开着。功能与 CLI 完全相同。',
    intgMcpHttpTitle: '本地 HTTP 服务',
    intgMcpHttpDesc:
      '在 Nawa 内运行，助手通过网址连接，可以看着它在 Word 编辑器里逐步生成。需要 Nawa 保持打开；目前只支持 Word。',
    intgMcpHttpAdvanced: '高级：其他地址与日志',
    intgMcpTryNote: '助手会通过 MCP 调用 Nawa，你不需要输入任何命令。',
    ...
    intgCliTitle: '高级：命令行 Nawa',
    intgCliReady: 'Nawa {v} · 已可在终端直接使用（{path}）',
    intgCliNotOnPath:
    ...
    intgCopied: '已复制',
    intgCliEphemeral: '请先把 Nawa 拖到「应用程序」，再使用命令行。',
    intgCopyPath: '复制路径',
    intgCliNeedsUpdate: '此 skill 需要命令行 {v} 或更新版本，请更新 Nawa。',
    intgLoading: '正在检测…',
    ...
    starPromptTitle: '喜欢 Nawa 吗？',
    starPromptTitleN: '你已经用 Nawa 打开了 {n} 个文档',
    starPromptBody: 'Nawa 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 Nawa，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle2: '这只是一个开始',
    onbBody2: 'Nawa 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
  ...
  en: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projects created on the web with cloud AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your cloud account to see projects you created on the web.',
    ...
    intgHeroTitle: 'Use Nawa from your AI assistant',
    intgHeroDesc:
    ...
    intgStep1Update:
      'When a Nawa update ships a newer skill, an Update button appears next to that assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pick its skills folder and Nawa writes the file there.',
    ...
    intgExample3: 'Convert budget.xlsx to PDF and open it in Nawa',
    intgStep2Note:
      'The assistant runs the Nawa command line itself; you never have to type it.',
    intgCliPartTitle: 'CLI · command line + skill',
    intgCliPartDesc:
      'For assistants that can run terminal commands (Claude Code, Codex, Cursor and others). Once the skill is installed, the assistant calls the Nawa command line itself to create, convert, read and edit files; you never type a command.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is the common protocol AI assistants use to call external tools. Use it when your assistant cannot run commands (Claude Desktop, for example) or when you want it to drive the Nawa window directly. Pick either of the two ways below.',
    intgMcpStdioTitle: 'Started by the assistant (recommended)',
    intgMcpStdioDesc:
      'The assistant launches Nawa mcp itself: nothing to switch on here, and Nawa does not need to be open. Same features as the CLI.',
    intgMcpHttpTitle: 'Local HTTP server',
    intgMcpHttpDesc:
      'Runs inside Nawa; the assistant connects to a URL and you can watch it build the document step by step in the Word editor. Nawa must stay open; Word documents only for now.',
    intgMcpHttpAdvanced: 'Advanced: other endpoints and log',
    intgMcpTryNote: 'The assistant calls Nawa through MCP; you never type a command.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Advanced: Nawa command line',
    intgCliReady: 'Nawa {v} · ready in your terminal ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Copied',
    intgCliEphemeral: 'Drag Nawa into Applications first, then use the command line.',
    intgCopyPath: 'Copy path',
    intgCliNeedsUpdate: 'This skill needs command line {v} or newer; update Nawa.',
    ...
    starPromptTitle: 'Enjoying Nawa?',
    starPromptTitleN: "You've opened {n} documents with Nawa",
    starPromptBody:
      'Nawa is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like Nawa, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    onbBody2:
      'Nawa is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
  ...
  ja: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Web で クラウド AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'クラウド アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'クラウド アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'クラウド アカウントでサインイン',
    loggedIn: 'サインイン済み',
    ...
    intgHeroTitle: 'AI アシスタントから Nawa を使う',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Nawa の更新で新しいスキルが届くと、そのアシスタントの横に「更新」ボタンが表示されます。',
    ...
    intgOtherFolderDesc: 'その skills フォルダーを選ぶと、Nawa がファイルを書き込みます。',
    ...
    intgExample3: 'budget.xlsx を PDF に変換して Nawa で開いて',
    intgStep2Note:
      'Nawa コマンドラインはアシスタントが自分で実行します。あなたが入力する必要はありません。',
    intgCliPartTitle: 'CLI · コマンドライン + skill',
    intgCliPartDesc:
      'ターミナルコマンドを実行できるアシスタント（Claude Code、Codex、Cursor など）向け。skill をインストールすると、アシスタントが自分で Nawa コマンドラインを呼び出してファイルを作成・変換・読み取り・編集します。コマンドを入力する必要はありません。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP は AI アシスタントが外部ツールを呼び出すための共通プロトコルです。アシスタントがコマンドを実行できない場合（Claude Desktop など）や、Nawa のウィンドウを直接操作させたい場合に使います。下の 2 つの方法からどちらか 1 つを選んでください。',
    intgMcpStdioTitle: 'アシスタントが起動する（推奨）',
    intgMcpStdioDesc:
      'アシスタントが Nawa mcp を自分で起動します。ここで何かをオンにする必要はなく、Nawa を開いておく必要もありません。機能は CLI と同じです。',
    intgMcpHttpTitle: 'ローカル HTTP サーバー',
    intgMcpHttpDesc:
      'Nawa 内で動作し、アシスタントは URL で接続します。Word エディター上で文書が段階的に生成される様子を見られます。Nawa を開いたままにする必要があり、現時点では Word のみ対応です。',
    intgMcpHttpAdvanced: '詳細：その他のエンドポイントとログ',
    intgMcpTryNote:
      'アシスタントが MCP 経由で Nawa を呼び出します。コマンドを入力する必要はありません。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '上級：コマンドライン Nawa',
    intgCliReady: 'Nawa {v} · ターミナルで使えます（{path}）',
    intgCliNotOnPath:
    ...
    intgCopied: 'コピーしました',
    intgCliEphemeral:
      '先に Nawa を「アプリケーション」に移してから、コマンドラインを使ってください。',
    intgCopyPath: 'パスをコピー',
    intgCliNeedsUpdate:
      'このスキルにはコマンドライン {v} 以降が必要です。Nawa を更新してください。',
    intgLoading: '確認中…',
    ...
    setAiGensparkHint: 'クラウド アカウントでサインインするため、API キーは不要です。',
    ...
    starPromptTitle: 'Nawa はいかがですか？',
    starPromptTitleN: 'Nawa で {n} 件のドキュメントを開きました',
    starPromptBody:
      'Nawa は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'Nawa が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      '클라우드 AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: '클라우드 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: '클라우드 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: '클라우드 계정으로 로그인',
    loggedIn: '로그인됨',
    ...
    intgHeroTitle: 'AI 어시스턴트에서 Nawa 사용하기',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Nawa 업데이트에 새 스킬이 포함되면 해당 어시스턴트 옆에 업데이트 버튼이 나타납니다.',
    ...
    intgOtherFolderDesc: '해당 skills 폴더를 선택하면 Nawa가 파일을 기록합니다.',
    ...
    intgExample3: 'budget.xlsx를 PDF로 변환해서 Nawa에서 열어 줘',
    intgStep2Note:
      'Nawa 명령줄은 어시스턴트가 직접 실행하므로 여러분이 입력할 필요가 없습니다.',
    intgCliPartTitle: 'CLI · 명령줄 + skill',
    intgCliPartDesc:
      '터미널 명령을 실행할 수 있는 어시스턴트(Claude Code, Codex, Cursor 등)용입니다. skill을 설치하면 어시스턴트가 스스로 Nawa 명령줄을 호출해 파일을 만들고 변환하고 읽고 편집합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP는 AI 어시스턴트가 외부 도구를 호출하는 공통 프로토콜입니다. 어시스턴트가 명령을 실행할 수 없거나(예: Claude Desktop) Nawa 창을 직접 조작하게 하려면 이 방식을 사용하세요. 아래 두 방법 중 하나를 선택하면 됩니다.',
    intgMcpStdioTitle: '어시스턴트가 실행(권장)',
    intgMcpStdioDesc:
      '어시스턴트가 Nawa mcp를 직접 실행합니다. 여기서 켤 것이 없고 Nawa가 열려 있을 필요도 없습니다. 기능은 CLI와 같습니다.',
    intgMcpHttpTitle: '로컬 HTTP 서버',
    intgMcpHttpDesc:
      'Nawa 안에서 실행되며 어시스턴트가 URL로 연결합니다. Word 편집기에서 문서가 단계별로 만들어지는 과정을 볼 수 있습니다. Nawa를 열어 두어야 하며 현재는 Word만 지원합니다.',
    intgMcpHttpAdvanced: '고급: 기타 주소와 로그',
    intgMcpTryNote:
      '어시스턴트가 MCP를 통해 Nawa를 호출합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '고급: 명령줄 Nawa',
    intgCliReady: 'Nawa {v} · 터미널에서 바로 사용 가능({path})',
    intgCliNotOnPath:
    ...
    intgCopied: '복사됨',
    intgCliEphemeral: '먼저 Nawa를 응용 프로그램 폴더로 옮긴 뒤 명령줄을 사용하세요.',
    intgCopyPath: '경로 복사',
    intgCliNeedsUpdate: '이 스킬은 명령줄 {v} 이상이 필요합니다. Nawa를 업데이트하세요.',
    intgLoading: '확인 중…',
    ...
    starPromptTitle: 'Nawa가 마음에 드시나요?',
    starPromptTitleN: 'Nawa로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'Nawa는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'Nawa가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      "Projets créés sur le web avec l’IA cloud. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte cloud pour voir les projets créés sur le web.',
    ...
    intgHeroTitle: 'Utiliser Nawa depuis votre assistant IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quand une mise à jour de Nawa apporte un skill plus récent, un bouton Mettre à jour apparaît à côté de cet assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Choisissez son dossier skills et Nawa y écrit le fichier.',
    ...
    intgExample3: 'Convertis budget.xlsx en PDF et ouvre-le dans Nawa',
    intgStep2Note:
      "L'assistant lance lui-même la ligne de commande Nawa ; vous n'avez jamais à la saisir.",
    intgCliPartTitle: 'CLI · ligne de commande + skill',
    intgCliPartDesc:
      'Pour les assistants capables de lancer des commandes dans le terminal (Claude Code, Codex, Cursor, etc.). Une fois le skill installé, l’assistant appelle lui-même la ligne de commande Nawa pour créer, convertir, lire et modifier les fichiers ; vous ne tapez jamais de commande.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP est le protocole commun que les assistants IA utilisent pour appeler des outils externes. Utilisez-le si votre assistant ne peut pas lancer de commandes (Claude Desktop, par exemple) ou si vous voulez qu’il pilote directement la fenêtre Nawa. Choisissez l’une des deux méthodes ci-dessous.',
    intgMcpStdioTitle: 'Lancé par l’assistant (recommandé)',
    intgMcpStdioDesc:
      'L’assistant lance lui-même Nawa mcp : rien à activer ici, et Nawa n’a pas besoin d’être ouvert. Mêmes fonctions que la CLI.',
    intgMcpHttpTitle: 'Serveur HTTP local',
    intgMcpHttpDesc:
      'Tourne dans Nawa ; l’assistant se connecte à une URL et vous voyez le document se construire pas à pas dans l’éditeur Word. Nawa doit rester ouvert ; documents Word uniquement pour l’instant.',
    intgMcpHttpAdvanced: 'Avancé : autres adresses et journal',
    intgMcpTryNote: 'L’assistant appelle Nawa via MCP ; vous ne tapez jamais de commande.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avancé : ligne de commande Nawa',
    intgCliReady: 'Nawa {v} · prêt dans votre terminal ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Copié',
    intgCliEphemeral:
      "Glissez d'abord Nawa dans Applications, puis utilisez la ligne de commande.",
    intgCopyPath: 'Copier le chemin',
    intgCliNeedsUpdate:
      'Ce skill requiert la ligne de commande {v} ou plus récente ; mettez Nawa à jour.',
    ...
    starPromptTitle: 'Nawa vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec Nawa',
    starPromptBody:
      'Nawa est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si Nawa vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Nawa est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
  ...
  de: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Mit Cloud-KI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Cloud-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    intgHeroTitle: 'Nawa aus Ihrem KI-Assistenten nutzen',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Bringt ein Nawa-Update einen neueren Skill mit, erscheint neben diesem Assistenten ein Aktualisieren-Button.',
    intgSkillVersion: 'Skill {v}',
    ...
    intgOtherFolderDesc:
      'Wählen Sie seinen Skills-Ordner, und Nawa schreibt die Datei dorthin.',
    ...
    intgExample3: 'Wandle budget.xlsx in PDF um und öffne es in Nawa',
    intgStep2Note:
      'Der Assistent ruft die Nawa-Befehlszeile selbst auf; Sie müssen sie nie eintippen.',
    intgCliPartTitle: 'CLI · Kommandozeile + Skill',
    intgCliPartDesc:
      'Für Assistenten, die Terminalbefehle ausführen können (Claude Code, Codex, Cursor u. a.). Nach der Installation des Skills ruft der Assistent die Nawa-Kommandozeile selbst auf, um Dateien zu erstellen, zu konvertieren, zu lesen und zu bearbeiten; Sie tippen nie einen Befehl.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ist das gemeinsame Protokoll, über das KI-Assistenten externe Werkzeuge aufrufen. Nutzen Sie es, wenn der Assistent keine Befehle ausführen kann (z. B. Claude Desktop) oder wenn er das Nawa-Fenster direkt steuern soll. Wählen Sie einen der beiden Wege unten.',
    intgMcpStdioTitle: 'Vom Assistenten gestartet (empfohlen)',
    intgMcpStdioDesc:
      'Der Assistent startet Nawa mcp selbst: hier ist nichts einzuschalten, und Nawa muss nicht geöffnet sein. Gleicher Funktionsumfang wie die CLI.',
    intgMcpHttpTitle: 'Lokaler HTTP-Server',
    intgMcpHttpDesc:
      'Läuft in Nawa; der Assistent verbindet sich über eine URL, und Sie sehen im Word-Editor zu, wie das Dokument Schritt für Schritt entsteht. Nawa muss geöffnet bleiben; derzeit nur Word-Dokumente.',
    intgMcpHttpAdvanced: 'Erweitert: weitere Adressen und Protokoll',
    intgMcpTryNote: 'Der Assistent ruft Nawa über MCP auf; Sie tippen nie einen Befehl.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Erweitert: Befehlszeile Nawa',
    intgCliReady: 'Nawa {v} · im Terminal verfügbar ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Kopiert',
    intgCliEphemeral:
      'Ziehen Sie Nawa zuerst in „Programme“, dann nutzen Sie die Befehlszeile.',
    intgCopyPath: 'Pfad kopieren',
    intgCliNeedsUpdate:
      'Dieser Skill braucht Befehlszeile {v} oder neuer; aktualisieren Sie Nawa.',
    intgLoading: 'Prüfe …',
    ...
    starPromptTitle: 'Gefällt Ihnen Nawa?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit Nawa geöffnet',
    starPromptBody:
      'Nawa ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen Nawa gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    onbBody2:
      'Nawa ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Proyectos creados en la web con IA en la nube. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta en la nube para ver los proyectos creados en la web.',
    ...
    intgHeroTitle: 'Usa Nawa desde tu asistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Cuando una actualización de Nawa traiga un skill más nuevo, aparecerá un botón Actualizar junto a ese asistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Elige su carpeta de skills y Nawa escribe el archivo ahí.',
    ...
    intgExample3: 'Convierte budget.xlsx a PDF y ábrelo en Nawa',
    intgStep2Note:
      'El asistente ejecuta la línea de comandos Nawa por sí mismo; nunca tienes que escribirla.',
    intgCliPartTitle: 'CLI · línea de comandos + skill',
    intgCliPartDesc:
      'Para asistentes que pueden ejecutar comandos de terminal (Claude Code, Codex, Cursor y otros). Con el skill instalado, el asistente llama por sí mismo a la línea de comandos Nawa para crear, convertir, leer y editar archivos; nunca escribes un comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP es el protocolo común con el que los asistentes de IA llaman a herramientas externas. Úsalo cuando tu asistente no pueda ejecutar comandos (Claude Desktop, por ejemplo) o cuando quieras que controle directamente la ventana de Nawa. Elige una de las dos formas de abajo.',
    intgMcpStdioTitle: 'Iniciado por el asistente (recomendado)',
    intgMcpStdioDesc:
      'El asistente lanza Nawa mcp por sí mismo: nada que activar aquí, y Nawa no necesita estar abierto. Mismas funciones que la CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Se ejecuta dentro de Nawa; el asistente se conecta a una URL y puedes ver cómo construye el documento paso a paso en el editor de Word. Nawa debe permanecer abierto; por ahora solo documentos Word.',
    intgMcpHttpAdvanced: 'Avanzado: otras direcciones y registro',
    intgMcpTryNote: 'El asistente llama a Nawa a través de MCP; nunca escribes un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avanzado: línea de comandos Nawa',
    intgCliReady: 'Nawa {v} · listo en tu terminal ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral: 'Arrastra primero Nawa a Aplicaciones y luego usa la línea de comandos.',
    intgCopyPath: 'Copiar ruta',
    intgCliNeedsUpdate:
      'Este skill necesita la línea de comandos {v} o superior; actualiza Nawa.',
    ...
    starPromptTitle: '¿Te gusta Nawa?',
    starPromptTitleN: 'Has abierto {n} documentos con Nawa',
    starPromptBody:
      'Nawa es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta Nawa, danos una estrella en GitHub.',
    ...
    onbBody2:
      'Nawa aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
  ...
  th: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย Cloud AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Cloud เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    intgHeroTitle: 'ใช้ Nawa จากผู้ช่วย AI ของคุณ',
    intgHeroDesc:
    ...
    intgStep1Update:
      'เมื่อการอัปเดต Nawa มาพร้อมสกิลเวอร์ชันใหม่ ปุ่มอัปเดตจะปรากฏข้างผู้ช่วยนั้น',
    ...
    intgOtherFolderDesc: 'เลือกโฟลเดอร์ skills ของผู้ช่วย แล้ว Nawa จะเขียนไฟล์ลงไป',
    ...
    intgExample3: 'แปลง budget.xlsx เป็น PDF แล้วเปิดใน Nawa',
    intgStep2Note: 'ผู้ช่วยจะเรียกใช้บรรทัดคำสั่ง Nawa เอง คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgCliPartTitle: 'CLI · บรรทัดคำสั่ง + skill',
    intgCliPartDesc:
      'สำหรับผู้ช่วยที่รันคำสั่งเทอร์มินัลได้ (Claude Code, Codex, Cursor และอื่น ๆ) เมื่อติดตั้ง skill แล้ว ผู้ช่วยจะเรียกบรรทัดคำสั่ง Nawa เองเพื่อสร้าง แปลง อ่าน และแก้ไขไฟล์ คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP คือโปรโตคอลกลางที่ผู้ช่วย AI ใช้เรียกเครื่องมือภายนอก ใช้เมื่อผู้ช่วยรันคำสั่งไม่ได้ (เช่น Claude Desktop) หรือเมื่อต้องการให้มันควบคุมหน้าต่าง Nawa โดยตรง เลือกวิธีใดวิธีหนึ่งจากสองวิธีด้านล่าง',
    intgMcpStdioTitle: 'ให้ผู้ช่วยเป็นผู้เริ่ม (แนะนำ)',
    intgMcpStdioDesc:
      'ผู้ช่วยจะเรียก Nawa mcp ขึ้นมาเอง ไม่ต้องเปิดสวิตช์ใดที่นี่ และไม่ต้องเปิด Nawa ไว้ ความสามารถเหมือน CLI ทุกประการ',
    intgMcpHttpTitle: 'เซิร์ฟเวอร์ HTTP ในเครื่อง',
    intgMcpHttpDesc:
      'ทำงานอยู่ใน Nawa ผู้ช่วยเชื่อมต่อผ่าน URL และคุณจะเห็นเอกสารค่อย ๆ ถูกสร้างขึ้นในตัวแก้ไข Word ต้องเปิด Nawa ไว้ตลอด ปัจจุบันรองรับเฉพาะ Word',
    intgMcpHttpAdvanced: 'ขั้นสูง: ที่อยู่อื่นและบันทึก',
    intgMcpTryNote: 'ผู้ช่วยจะเรียก Nawa ผ่าน MCP คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'ขั้นสูง: บรรทัดคำสั่ง Nawa',
    intgCliReady: 'Nawa {v} · พร้อมใช้ในเทอร์มินัล ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral: 'กรุณาลาก Nawa ไปที่ Applications ก่อน แล้วจึงใช้บรรทัดคำสั่ง',
    intgCopyPath: 'คัดลอกพาธ',
    intgCliNeedsUpdate: 'สกิลนี้ต้องใช้บรรทัดคำสั่ง {v} หรือใหม่กว่า โปรดอัปเดต Nawa',
    ...
    starPromptTitle: 'ชอบ Nawa ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย Nawa ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'Nawa ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ Nawa ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Nawa',
    ...
    onbBody2:
      'Nawa ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
  ...
  id: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan AI cloud. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun cloud untuk melihat proyek yang Anda buat di web.',
    ...
    intgHeroTitle: 'Gunakan Nawa dari asisten AI Anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Saat pembaruan Nawa membawa skill yang lebih baru, tombol Perbarui muncul di samping asisten itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills-nya dan Nawa menulis file di sana.',
    ...
    intgExample3: 'Konversi budget.xlsx ke PDF dan buka di Nawa',
    intgStep2Note:
      'Asisten menjalankan baris perintah Nawa sendiri; Anda tidak perlu mengetiknya.',
    intgCliPartTitle: 'CLI · baris perintah + skill',
    intgCliPartDesc:
      'Untuk asisten yang bisa menjalankan perintah terminal (Claude Code, Codex, Cursor, dan lainnya). Setelah skill terpasang, asisten memanggil baris perintah Nawa sendiri untuk membuat, mengonversi, membaca, dan mengedit file; Anda tidak pernah mengetik perintah.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP adalah protokol umum yang dipakai asisten AI untuk memanggil alat eksternal. Gunakan saat asisten Anda tidak bisa menjalankan perintah (misalnya Claude Desktop) atau saat Anda ingin ia mengendalikan jendela Nawa secara langsung. Pilih salah satu dari dua cara di bawah.',
    intgMcpStdioTitle: 'Dijalankan oleh asisten (disarankan)',
    intgMcpStdioDesc:
      'Asisten menjalankan Nawa mcp sendiri: tidak ada yang perlu dinyalakan di sini, dan Nawa tidak perlu terbuka. Fitur sama dengan CLI.',
    intgMcpHttpTitle: 'Server HTTP lokal',
    intgMcpHttpDesc:
      'Berjalan di dalam Nawa; asisten terhubung lewat URL dan Anda bisa melihat dokumen dibangun langkah demi langkah di editor Word. Nawa harus tetap terbuka; untuk saat ini hanya dokumen Word.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote: 'Asisten memanggil Nawa melalui MCP; Anda tidak pernah mengetik perintah.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Lanjutan: baris perintah Nawa',
    intgCliReady: 'Nawa {v} · siap di terminal Anda ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret Nawa ke Applications dulu, lalu gunakan baris perintah.',
    intgCopyPath: 'Salin path',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris perintah {v} atau lebih baru; perbarui Nawa.',
    ...
    starPromptTitle: 'Suka Nawa?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Nawa',
    starPromptBody:
      'Nawa gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai Nawa, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Nawa',
    ...
    onbBody2:
      'Nawa masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
  ...
  ru: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с облачным ИИ. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в облачный аккаунт, чтобы увидеть проекты, созданные в вебе.',
    ...
    intgHeroTitle: 'Используйте Nawa из своего ИИ-ассистента',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Когда обновление Nawa принесёт более новый скилл, рядом с этим ассистентом появится кнопка «Обновить».',
    ...
    intgOtherFolderDesc: 'Выберите его папку skills, и Nawa запишет файл туда.',
    ...
    intgExample3: 'Конвертируй budget.xlsx в PDF и открой в Nawa',
    intgStep2Note:
      'Ассистент сам запускает командную строку Nawa; вводить её вам не придётся.',
    intgCliPartTitle: 'CLI · командная строка + skill',
    intgCliPartDesc:
      'Для ассистентов, умеющих выполнять команды терминала (Claude Code, Codex, Cursor и другие). После установки skill ассистент сам вызывает командную строку Nawa, чтобы создавать, конвертировать, читать и редактировать файлы; вам не нужно вводить команды.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP — общий протокол, через который ИИ-ассистенты вызывают внешние инструменты. Используйте его, если ассистент не умеет выполнять команды (например, Claude Desktop) или если хотите, чтобы он напрямую управлял окном Nawa. Выберите один из двух способов ниже.',
    intgMcpStdioTitle: 'Запускает ассистент (рекомендуется)',
    intgMcpStdioDesc:
      'Ассистент сам запускает Nawa mcp: здесь ничего включать не нужно, и Nawa не обязан быть открыт. Те же возможности, что у CLI.',
    intgMcpHttpTitle: 'Локальный HTTP-сервер',
    intgMcpHttpDesc:
      'Работает внутри Nawa; ассистент подключается по URL, и вы видите, как документ шаг за шагом собирается в редакторе Word. Nawa должен оставаться открытым; пока только документы Word.',
    intgMcpHttpAdvanced: 'Дополнительно: другие адреса и журнал',
    intgMcpTryNote: 'Ассистент обращается к Nawa через MCP; вам не нужно вводить команды.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Дополнительно: командная строка Nawa',
    intgCliReady: 'Nawa {v} · доступен в терминале ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral:
      'Сначала перетащите Nawa в «Программы», затем используйте командную строку.',
    intgCopyPath: 'Копировать путь',
    intgCliNeedsUpdate: 'Этому скиллу нужна командная строка {v} или новее; обновите Nawa.',
    ...
    starPromptTitle: 'Нравится Nawa?',
    starPromptTitleN: 'Вы уже открыли {n} документов в Nawa',
    starPromptBody:
      'Nawa — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится Nawa, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Nawa',
    ...
    onbBody2:
      'Nawa пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
  ...
  ar: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام الذكاء الاصطناعي السحابي. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى الحساب السحابي لعرض المشاريع التي أنشأتها على الويب.',
    ...
    intgHeroTitle: 'استخدم Nawa من مساعد الذكاء الاصطناعي',
    intgHeroDesc:
    ...
    intgStep1Update: 'عندما يجلب تحديث Nawa مهارة أحدث، يظهر زر «تحديث» بجوار ذلك المساعد.',
    ...
    intgOtherFolderDesc: 'اختر مجلد skills الخاص به وسيكتب Nawa الملف هناك.',
    ...
    intgExample3: 'حوّل budget.xlsx إلى PDF وافتحه في Nawa',
    intgStep2Note: 'المساعد يشغّل سطر أوامر Nawa بنفسه؛ لن تحتاج إلى كتابته أبداً.',
    intgCliPartTitle: 'CLI · سطر الأوامر + skill',
    intgCliPartDesc:
      'للمساعدين الذين يستطيعون تنفيذ أوامر الطرفية (Claude Code وCodex وCursor وغيرها). بعد تثبيت skill، يستدعي المساعد سطر أوامر Nawa بنفسه لإنشاء الملفات وتحويلها وقراءتها وتحريرها؛ لن تكتب أي أمر.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP هو البروتوكول المشترك الذي يستخدمه مساعدو الذكاء الاصطناعي لاستدعاء أدوات خارجية. استخدمه إذا كان مساعدك لا يستطيع تنفيذ الأوامر (مثل Claude Desktop) أو إذا أردت أن يتحكم في نافذة Nawa مباشرة. اختر إحدى الطريقتين أدناه.',
    intgMcpStdioTitle: 'يشغّله المساعد (موصى به)',
    intgMcpStdioDesc:
      'يشغّل المساعد Nawa mcp بنفسه: لا شيء لتفعيله هنا، ولا يلزم أن يكون Nawa مفتوحًا. نفس إمكانات CLI.',
    intgMcpHttpTitle: 'خادم HTTP محلي',
    intgMcpHttpDesc:
      'يعمل داخل Nawa؛ يتصل المساعد عبر عنوان URL ويمكنك مشاهدة المستند يُبنى خطوة بخطوة في محرر Word. يجب أن يبقى Nawa مفتوحًا؛ مستندات Word فقط حاليًا.',
    intgMcpHttpAdvanced: 'متقدم: عناوين أخرى والسجل',
    intgMcpTryNote: 'يستدعي المساعد Nawa عبر MCP؛ لن تكتب أي أمر.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'متقدم: سطر أوامر Nawa',
    intgCliReady: 'Nawa {v} · جاهز في الطرفية ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'تم النسخ',
    intgCliEphemeral: 'اسحب Nawa إلى مجلد التطبيقات أولاً، ثم استخدم سطر الأوامر.',
    intgCopyPath: 'نسخ المسار',
    intgCliNeedsUpdate: 'تحتاج هذه المهارة إلى سطر الأوامر {v} أو أحدث؛ حدّث Nawa.',
    ...
    starPromptTitle: 'هل أعجبك Nawa؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في Nawa',
    starPromptBody: 'Nawa مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك Nawa، ضع لنا نجمة على GitHub.',
    ...
    onbBody2:
      'لا يزال Nawa في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
  ...
  pt: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projetos criados na web com IA na nuvem. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta na nuvem para ver os projetos criados na web.',
    ...
    intgHeroTitle: 'Use o Nawa a partir do seu assistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quando uma atualização do Nawa trouxer um skill mais novo, um botão Atualizar aparece ao lado desse assistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Escolha a pasta de skills dele e o Nawa grava o arquivo lá.',
    ...
    intgExample3: 'Converta budget.xlsx para PDF e abra no Nawa',
    intgStep2Note:
      'O assistente executa a linha de comando Nawa sozinho; você nunca precisa digitá-la.',
    intgCliPartTitle: 'CLI · linha de comando + skill',
    intgCliPartDesc:
      'Para assistentes que executam comandos de terminal (Claude Code, Codex, Cursor e outros). Com o skill instalado, o assistente chama a linha de comando Nawa sozinho para criar, converter, ler e editar arquivos; você nunca digita um comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP é o protocolo comum que assistentes de IA usam para chamar ferramentas externas. Use-o quando o assistente não puder executar comandos (Claude Desktop, por exemplo) ou quando quiser que ele controle a janela do Nawa diretamente. Escolha uma das duas formas abaixo.',
    intgMcpStdioTitle: 'Iniciado pelo assistente (recomendado)',
    intgMcpStdioDesc:
      'O assistente inicia o Nawa mcp sozinho: nada para ligar aqui, e o Nawa não precisa estar aberto. Mesmos recursos da CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Roda dentro do Nawa; o assistente conecta por URL e você acompanha o documento sendo montado passo a passo no editor Word. O Nawa precisa ficar aberto; por enquanto só documentos Word.',
    intgMcpHttpAdvanced: 'Avançado: outros endereços e log',
    intgMcpTryNote: 'O assistente chama o Nawa via MCP; você nunca digita um comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avançado: linha de comando Nawa',
    intgCliReady: 'Nawa {v} · pronto no seu terminal ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral:
      'Arraste o Nawa para Aplicativos primeiro e depois use a linha de comando.',
    intgCopyPath: 'Copiar caminho',
    intgCliNeedsUpdate:
      'Este skill precisa da linha de comando {v} ou mais recente; atualize o Nawa.',
    ...
    starPromptTitle: 'Gostando do Nawa?',
    starPromptTitleN: 'Você já abriu {n} documentos com o Nawa',
    starPromptBody:
      'O Nawa é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do Nawa, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'O Nawa ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
  ...
  it: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Progetti creati sul web con IA en la nube. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account cloud per vedere i progetti creati sul web.',
    ...
    intgHeroTitle: 'Usa Nawa dal tuo assistente IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      "Quando un aggiornamento di Nawa porta uno skill più recente, accanto a quell'assistente compare un pulsante Aggiorna.",
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Scegli la sua cartella skills e Nawa vi scrive il file.',
    ...
    intgExample3: 'Converti budget.xlsx in PDF e aprilo in Nawa',
    intgStep2Note:
      "L'assistente esegue da solo la riga di comando Nawa; non dovrai mai digitarla.",
    intgCliPartTitle: 'CLI · riga di comando + skill',
    intgCliPartDesc:
      'Per assistenti che possono eseguire comandi da terminale (Claude Code, Codex, Cursor e altri). Installato lo skill, l’assistente richiama da sé la riga di comando Nawa per creare, convertire, leggere e modificare file; non digiti mai un comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP è il protocollo comune con cui gli assistenti IA richiamano strumenti esterni. Usalo quando l’assistente non può eseguire comandi (Claude Desktop, ad esempio) o quando vuoi che controlli direttamente la finestra di Nawa. Scegli uno dei due modi qui sotto.',
    intgMcpStdioTitle: 'Avviato dall’assistente (consigliato)',
    intgMcpStdioDesc:
      'L’assistente avvia Nawa mcp da sé: niente da attivare qui, e Nawa non deve essere aperto. Stesse funzioni della CLI.',
    intgMcpHttpTitle: 'Server HTTP locale',
    intgMcpHttpDesc:
      'Gira dentro Nawa; l’assistente si collega a un URL e puoi vedere il documento prendere forma passo dopo passo nell’editor Word. Nawa deve restare aperto; per ora solo documenti Word.',
    intgMcpHttpAdvanced: 'Avanzato: altri indirizzi e registro',
    intgMcpTryNote: 'L’assistente richiama Nawa tramite MCP; non digiti mai un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avanzato: riga di comando Nawa',
    intgCliReady: 'Nawa {v} · pronto nel terminale ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'Copiato',
    intgCliEphemeral: 'Trascina prima Nawa in Applicazioni, poi usa la riga di comando.',
    intgCopyPath: 'Copia percorso',
    intgCliNeedsUpdate:
      'Questo skill richiede la riga di comando {v} o successiva; aggiorna Nawa.',
    ...
    starPromptTitle: 'Ti piace Nawa?',
    starPromptTitleN: 'Hai aperto {n} documenti con Nawa',
    starPromptBody:
      'Nawa è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace Nawa, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    onbBody2:
      'Nawa è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
  ...
  pl: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą chmurowego AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto w chmurze, aby zobaczyć projekty utworzone w sieci.',
    ...
    intgHeroTitle: 'Używaj Nawa ze swojego asystenta AI',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Gdy aktualizacja Nawa przyniesie nowszy skill, obok tego asystenta pojawi się przycisk Aktualizuj.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Wybierz jego folder skills, a Nawa zapisze tam plik.',
    ...
    intgExample3: 'Przekonwertuj budget.xlsx do PDF i otwórz w Nawa',
    intgStep2Note: 'Asystent sam uruchamia wiersz poleceń Nawa; nigdy nie musisz go wpisywać.',
    intgCliPartTitle: 'CLI · wiersz poleceń + skill',
    intgCliPartDesc:
      'Dla asystentów, które potrafią uruchamiać polecenia terminala (Claude Code, Codex, Cursor i inne). Po zainstalowaniu skilla asystent sam wywołuje wiersz poleceń Nawa, aby tworzyć, konwertować, czytać i edytować pliki; nigdy nie wpisujesz polecenia.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP to wspólny protokół, którym asystenci AI wywołują zewnętrzne narzędzia. Użyj go, gdy asystent nie potrafi uruchamiać poleceń (np. Claude Desktop) lub gdy chcesz, aby bezpośrednio sterował oknem Nawa. Wybierz jeden z dwóch sposobów poniżej.',
    intgMcpStdioTitle: 'Uruchamiany przez asystenta (zalecane)',
    intgMcpStdioDesc:
      'Asystent sam uruchamia Nawa mcp: nic tu nie trzeba włączać, a Nawa nie musi być otwarty. Te same funkcje co CLI.',
    intgMcpHttpTitle: 'Lokalny serwer HTTP',
    intgMcpHttpDesc:
      'Działa wewnątrz Nawa; asystent łączy się przez URL, a Ty widzisz, jak dokument powstaje krok po kroku w edytorze Word. Nawa musi pozostać otwarty; na razie tylko dokumenty Word.',
    intgMcpHttpAdvanced: 'Zaawansowane: inne adresy i dziennik',
    intgMcpTryNote: 'Asystent wywołuje Nawa przez MCP; nigdy nie wpisujesz polecenia.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Zaawansowane: wiersz poleceń Nawa',
    intgCliReady: 'Nawa {v} · gotowy w terminalu ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral: 'Najpierw przenieś Nawa do Aplikacji, potem użyj wiersza poleceń.',
    intgCopyPath: 'Kopiuj ścieżkę',
    intgCliNeedsUpdate: 'Ten skill wymaga wiersza poleceń {v} lub nowszego; zaktualizuj Nawa.',
    ...
    starPromptTitle: 'Podoba Ci się Nawa?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w Nawa',
    starPromptBody:
      'Nawa jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się Nawa, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Nawa jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
  ...
  cs: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projekty vytvořené na webu pomocí cloudové AI. Úpravy pokračují v prohlížeči — klikněte na projekt a otevřete ho.',
    ...
    cloudLoginHint:
      'Přihlaste se ke svému cloudovému účtu a zobrazte projekty, které jste vytvořili na webu.',
    ...
    intgHeroTitle: 'Používejte Nawa ze svého AI asistenta',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Když aktualizace Nawa přinese novější skill, u daného asistenta se objeví tlačítko Aktualizovat.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Vyberte jeho složku skills a Nawa tam soubor zapíše.',
    ...
    intgExample3: 'Převeď budget.xlsx do PDF a otevři ho v Nawa',
    intgStep2Note: 'Asistent spouští příkazový řádek Nawa sám; nikdy ho nemusíte psát.',
    intgCliPartTitle: 'CLI · příkazový řádek + skill',
    intgCliPartDesc:
      'Pro asistenty, kteří umí spouštět příkazy terminálu (Claude Code, Codex, Cursor a další). Po instalaci skillu asistent sám volá příkazový řádek Nawa k vytváření, převodu, čtení a úpravám souborů; žádný příkaz nepíšete.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP je společný protokol, kterým AI asistenti volají externí nástroje. Použijte ho, když asistent neumí spouštět příkazy (např. Claude Desktop) nebo když chcete, aby přímo ovládal okno Nawa. Vyberte jeden ze dvou způsobů níže.',
    intgMcpStdioTitle: 'Spouští asistent (doporučeno)',
    intgMcpStdioDesc:
      'Asistent spustí Nawa mcp sám: tady není co zapínat a Nawa nemusí být otevřený. Stejné funkce jako CLI.',
    intgMcpHttpTitle: 'Místní HTTP server',
    intgMcpHttpDesc:
      'Běží uvnitř Nawa; asistent se připojí přes URL a v editoru Word sledujete, jak dokument krok za krokem vzniká. Nawa musí zůstat otevřený; zatím jen dokumenty Word.',
    intgMcpHttpAdvanced: 'Pokročilé: další adresy a protokol',
    intgMcpTryNote: 'Asistent volá Nawa přes MCP; žádný příkaz nepíšete.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Pokročilé: příkazový řádek Nawa',
    intgCliReady: 'Nawa {v} · připraven v terminálu ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral: 'Nejprve přetáhněte Nawa do Aplikací a poté použijte příkazový řádek.',
    intgCopyPath: 'Kopírovat cestu',
    intgCliNeedsUpdate:
      'Tento skill vyžaduje příkazový řádek {v} nebo novější; aktualizujte Nawa.',
    ...
    starPromptTitle: 'Líbí se vám Nawa?',
    starPromptTitleN: 'V Nawa jste otevřeli už {n} dokumentů',
    starPromptBody:
      'Nawa je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám Nawa líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Nawa je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
  ...
  nl: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met cloud-AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je cloudaccount om projecten te zien die je op het web hebt gemaakt.',
    ...
    intgHeroTitle: 'Nawa gebruiken vanuit uw AI-assistent',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Wanneer een Nawa-update een nieuwere skill meebrengt, verschijnt naast die assistent een knop Bijwerken.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Kies zijn skills-map en Nawa schrijft het bestand daar.',
    ...
    intgExample3: 'Zet budget.xlsx om naar PDF en open het in Nawa',
    intgStep2Note:
      'De assistent voert de Nawa-opdrachtregel zelf uit; u hoeft die nooit te typen.',
    intgCliPartTitle: 'CLI · opdrachtregel + skill',
    intgCliPartDesc:
      'Voor assistenten die terminalopdrachten kunnen uitvoeren (Claude Code, Codex, Cursor en andere). Na installatie van de skill roept de assistent zelf de Nawa-opdrachtregel aan om bestanden te maken, converteren, lezen en bewerken; je typt nooit een opdracht.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is het gemeenschappelijke protocol waarmee AI-assistenten externe tools aanroepen. Gebruik het als je assistent geen opdrachten kan uitvoeren (bijvoorbeeld Claude Desktop) of als je wilt dat hij het Nawa-venster rechtstreeks bestuurt. Kies een van de twee manieren hieronder.',
    intgMcpStdioTitle: 'Gestart door de assistent (aanbevolen)',
    intgMcpStdioDesc:
      'De assistent start Nawa mcp zelf: hier hoeft niets aan, en Nawa hoeft niet open te staan. Dezelfde functies als de CLI.',
    intgMcpHttpTitle: 'Lokale HTTP-server',
    intgMcpHttpDesc:
      'Draait in Nawa; de assistent verbindt via een URL en je ziet het document stap voor stap ontstaan in de Word-editor. Nawa moet open blijven; voorlopig alleen Word-documenten.',
    intgMcpHttpAdvanced: 'Geavanceerd: andere adressen en logboek',
    intgMcpTryNote: 'De assistent roept Nawa aan via MCP; je typt nooit een opdracht.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Geavanceerd: Nawa-opdrachtregel',
    intgCliReady: 'Nawa {v} · klaar in uw terminal ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral: "Sleep Nawa eerst naar Programma's en gebruik daarna de opdrachtregel.",
    intgCopyPath: 'Pad kopiëren',
    intgCliNeedsUpdate: 'Deze skill vereist opdrachtregel {v} of nieuwer; werk Nawa bij.',
    ...
    starPromptTitle: 'Bevalt Nawa?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met Nawa',
    starPromptBody:
      'Nawa is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als Nawa je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Nawa is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan AI cloud. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun awan untuk melihat projek yang anda cipta di web.',
    ...
    setSecAbout: 'Perihal',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan Nawa daripada pembantu AI anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Apabila kemas kini Nawa membawa skill yang lebih baharu, butang Kemas kini muncul di sebelah pembantu itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills pembantu itu dan Nawa menulis fail di sana.',
    ...
    intgExample3: 'Tukar budget.xlsx kepada PDF dan buka dalam Nawa',
    intgStep2Note:
      'Pembantu menjalankan baris arahan Nawa sendiri; anda tidak perlu menaipnya.',
    intgCliPartTitle: 'CLI · baris arahan + skill',
    intgCliPartDesc:
      'Untuk pembantu yang boleh menjalankan arahan terminal (Claude Code, Codex, Cursor dan lain-lain). Setelah skill dipasang, pembantu memanggil baris arahan Nawa sendiri untuk mencipta, menukar, membaca dan mengedit fail; anda tidak perlu menaip sebarang arahan.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ialah protokol umum yang digunakan pembantu AI untuk memanggil alat luaran. Gunakannya apabila pembantu anda tidak boleh menjalankan arahan (contohnya Claude Desktop) atau apabila anda mahu ia mengawal tetingkap Nawa secara langsung. Pilih salah satu daripada dua cara di bawah.',
    intgMcpStdioTitle: 'Dimulakan oleh pembantu (disyorkan)',
    intgMcpStdioDesc:
      'Pembantu melancarkan Nawa mcp sendiri: tiada apa yang perlu dihidupkan di sini, dan Nawa tidak perlu dibuka. Ciri sama seperti CLI.',
    intgMcpHttpTitle: 'Pelayan HTTP tempatan',
    intgMcpHttpDesc:
      'Berjalan di dalam Nawa; pembantu menyambung melalui URL dan anda boleh melihat dokumen dibina langkah demi langkah dalam editor Word. Nawa mesti kekal dibuka; buat masa ini dokumen Word sahaja.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote:
      'Pembantu memanggil Nawa melalui MCP; anda tidak perlu menaip sebarang arahan.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Lanjutan: baris arahan Nawa',
    intgCliReady: 'Nawa {v} · sedia dalam terminal anda ({path})',
    intgCliNotOnPath:
    ...
    intgSavedTo: 'Disimpan ke {path}',
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret Nawa ke Applications dahulu, kemudian gunakan baris arahan.',
    intgCopyPath: 'Salin laluan',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris arahan {v} atau lebih baharu; kemas kini Nawa.',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Nawa',
    starPromptBody:
      'Nawa percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka Nawa, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Nawa',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Nawa masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם בינת ענן. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון הענן כדי לראות פרויקטים שיצרתם באתר.',
    ...
    intgHeroTitle: 'שימוש ב-Nawa מתוך עוזר ה-AI שלכם',
    intgHeroDesc:
    ...
    intgStep1Update: 'כשעדכון של Nawa מביא skill חדש יותר, ליד אותו עוזר יופיע כפתור עדכון.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'בחרו את תיקיית ה-skills שלו ו-Nawa יכתוב שם את הקובץ.',
    ...
    intgExample3: 'המר את budget.xlsx ל-PDF ופתח אותו ב-Nawa',
    intgStep2Note: 'העוזר מריץ בעצמו את שורת הפקודה Nawa; לעולם לא תצטרכו להקליד אותה.',
    intgCliPartTitle: 'CLI · שורת פקודה + skill',
    intgCliPartDesc:
      'לעוזרים שיכולים להריץ פקודות טרמינל (Claude Code‏, Codex‏, Cursor ואחרים). לאחר התקנת ה‑skill העוזר קורא בעצמו לשורת הפקודה Nawa כדי ליצור, להמיר, לקרוא ולערוך קבצים; אתם לא מקלידים שום פקודה.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP הוא הפרוטוקול המשותף שבו עוזרי AI קוראים לכלים חיצוניים. השתמשו בו כשהעוזר אינו יכול להריץ פקודות (למשל Claude Desktop) או כשאתם רוצים שהוא ישלוט ישירות בחלון Nawa. בחרו אחת משתי הדרכים למטה.',
    intgMcpStdioTitle: 'מופעל על ידי העוזר (מומלץ)',
    intgMcpStdioDesc:
      'העוזר מפעיל את Nawa mcp בעצמו: אין מה להפעיל כאן, ו‑Nawa לא חייב להיות פתוח. אותן יכולות כמו ב‑CLI.',
    intgMcpHttpTitle: 'שרת HTTP מקומי',
    intgMcpHttpDesc:
      'פועל בתוך Nawa; העוזר מתחבר דרך כתובת URL ואפשר לראות את המסמך נבנה צעד אחר צעד בעורך Word. Nawa חייב להישאר פתוח; בשלב זה מסמכי Word בלבד.',
    intgMcpHttpAdvanced: 'מתקדם: כתובות נוספות ויומן',
    intgMcpTryNote: 'העוזר קורא ל‑Nawa דרך MCP; אתם לא מקלידים שום פקודה.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'מתקדם: שורת הפקודה Nawa',
    intgCliReady: 'Nawa {v} · מוכן בטרמינל ({path})',
    intgCliNotOnPath:
    ...
    intgCopied: 'הועתק',
    intgCliEphemeral: 'גררו קודם את Nawa לתיקיית היישומים, ואז השתמשו בשורת הפקודה.',
    intgCopyPath: 'העתקת נתיב',
    intgCliNeedsUpdate: 'skill זה דורש שורת פקודה {v} ומעלה; עדכנו את Nawa.',
    intgLoading: 'בודק…',
    ...
    starPromptTitle: 'נהנים מ-Nawa?',
    starPromptTitleN: 'פתחת {n} מסמכים עם Nawa',
    starPromptBody: 'Nawa חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם Nawa מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    onbBody2:
      'Nawa עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
  ...
  hi: {
    ...
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'क्लाउड AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने क्लाउड खाते में साइन इन करें।',
    ...
    intgHeroTitle: 'अपने AI असिस्टेंट से Nawa इस्तेमाल करें',
    intgHeroDesc:
    ...
    intgStep1Update:
      'जब Nawa के अपडेट में नया skill आता है, तो उस असिस्टेंट के पास अपडेट बटन दिखता है।',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'उसका skills फ़ोल्डर चुनें, Nawa वहाँ फ़ाइल लिख देगा।',
    ...
    intgExample3: 'budget.xlsx को PDF में बदलो और Nawa में खोलो',
    intgStep2Note: 'Nawa कमांड लाइन असिस्टेंट खुद चलाता है; आपको कभी टाइप नहीं करना पड़ता।',
    intgCliPartTitle: 'CLI · कमांड लाइन + skill',
    intgCliPartDesc:
      'उन सहायकों के लिए जो टर्मिनल कमांड चला सकते हैं (Claude Code, Codex, Cursor आदि)। skill इंस्टॉल होने के बाद सहायक फ़ाइलें बनाने, बदलने, पढ़ने और संपादित करने के लिए खुद Nawa कमांड लाइन चलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP वह साझा प्रोटोकॉल है जिससे AI सहायक बाहरी टूल बुलाते हैं। इसे तब चुनें जब सहायक कमांड न चला सके (जैसे Claude Desktop) या आप चाहें कि वह Nawa की विंडो को सीधे चलाए। नीचे दिए दो तरीकों में से कोई एक चुनें।',
    intgMcpStdioTitle: 'सहायक द्वारा शुरू (अनुशंसित)',
    intgMcpStdioDesc:
      'सहायक खुद Nawa mcp चलाता है: यहाँ कुछ चालू करने की ज़रूरत नहीं, और Nawa खुला होना भी ज़रूरी नहीं। सुविधाएँ CLI जैसी ही।',
    intgMcpHttpTitle: 'स्थानीय HTTP सर्वर',
    intgMcpHttpDesc:
      'Nawa के अंदर चलता है; सहायक URL से जुड़ता है और आप Word संपादक में दस्तावेज़ को चरण-दर-चरण बनते देख सकते हैं। Nawa खुला रहना चाहिए; अभी केवल Word दस्तावेज़।',
    intgMcpHttpAdvanced: 'उन्नत: अन्य पते और लॉग',
    intgMcpTryNote:
      'सहायक MCP के ज़रिये Nawa को बुलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'उन्नत: Nawa कमांड लाइन',
    intgCliReady: 'Nawa {v} · टर्मिनल में तैयार ({path})',
    intgCliNotOnPath:
    ...
    intgCliEphemeral: 'पहले Nawa को Applications में खींचें, फिर कमांड लाइन का उपयोग करें।',
    intgCopyPath: 'पथ कॉपी करें',
    intgCliNeedsUpdate: 'इस skill को कमांड लाइन {v} या नया चाहिए; Nawa अपडेट करें।',
    ...
    starPromptTitle: 'Nawa पसंद आ रहा है?',
    starPromptTitleN: 'आपने Nawa में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'Nawa मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको Nawa पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Nawa में आपका स्वागत है',
    ...
    onbBody2:
      'Nawa अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
  ...
  'zh-TW': {
    ...
    navStarred: '收藏',
    navCloud: 'Cloud Projects',
    cloudSubtitle: '在網頁端用雲端 AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入雲端帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    intgStep1Update: 'Nawa 升級帶來新版 skill 時，對應助理旁會出現「更新」按鈕。',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: '選擇它的 skills 資料夾，Nawa 會把檔案寫進去。',
    ...
    intgExample3: '把 budget.xlsx 轉成 PDF，並在 Nawa 中開啟',
    intgStep2Note: '助理會自行呼叫 Nawa 命令列，你不需要輸入任何指令。',
    intgCliPartTitle: 'CLI · 命令列 + skill',
    intgCliPartDesc:
      '適合能執行終端機指令的助理（Claude Code、Codex、Cursor 等）。安裝 skill 後，助理會自己呼叫 Nawa 命令列建立、轉換、讀取和編輯檔案，你不需要輸入任何指令。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助理呼叫外部工具的通用協定。助理不能執行指令（如 Claude Desktop），或你想讓它直接操作 Nawa 視窗時用這條路。下面兩種接法任選一種。',
    intgMcpStdioTitle: '由助理啟動（建議）',
    intgMcpStdioDesc:
      '助理自己啟動 Nawa mcp，不需要在這裡開任何開關，Nawa 也不用開著。功能與 CLI 完全相同。',
    intgMcpHttpTitle: '本機 HTTP 服務',
    intgMcpHttpDesc:
      '在 Nawa 內執行，助理透過網址連線，可以看著它在 Word 編輯器裡逐步產生。需要 Nawa 保持開啟；目前只支援 Word。',
    intgMcpHttpAdvanced: '進階：其他位址與記錄',
    intgMcpTryNote: '助理會透過 MCP 呼叫 Nawa，你不需要輸入任何指令。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '進階：命令列 Nawa',
    intgCliReady: 'Nawa {v} · 已可在終端機直接使用（{path}）',
    intgCliNotOnPath:
    ...
    intgCopied: '已複製',
    intgCliEphemeral: '請先把 Nawa 拖到「應用程式」，再使用命令列。',
    intgCopyPath: '複製路徑',
    intgCliNeedsUpdate: '此 skill 需要命令列 {v} 或更新版本，請更新 Nawa。',
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    ...
    starPromptTitle: '喜歡 Nawa 嗎？',
    starPromptTitleN: '你已經用 Nawa 開啟了 {n} 個文件',
    starPromptBody: 'Nawa 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 Nawa，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    onbTitle2: '這只是一個開始',
    onbBody2: 'Nawa 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
