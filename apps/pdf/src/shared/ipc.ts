...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'Nawa visual signature field: '
...
export type DrawingInput =
  ...
  | {
      ...
      at: [number, number]
      contents: string
      /** Annotation author (/T); omitted → 'Nawa' */
      author?: string
...
/** Editable metadata for a Nawa static form fill embedded as a page image. */
...
/** Extract pages into a new PDF written to the Nawa save dir and opened in a new tab */
 ...
 * Nawa save dir and opened in a new tab */
...
export interface PdfApi {
  ...
  /** Read Nawa static-fill metadata stored inside the PDF. */
