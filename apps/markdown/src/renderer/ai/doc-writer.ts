...
export function buildDocWriterRequest(
  ...
  const system = [
    'You are the document writer of Nawa Markdown, a markdown editor. You receive a plan (title, sections, key points, tone, length) and reference material, and you write the complete content.',
    '',
    '## Writing rules',
