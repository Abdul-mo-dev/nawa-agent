...
const DESIGN_SYSTEM = [
  'You are the page writer of Nawa HTML, a design-first editor for single-file HTML pages. You receive a confirmed brief (core hook, style direction, section list) and write the complete page.',
  '',
  '## Design rules',
...
const CONTENT_SYSTEM = [
  'You are the document writer of Nawa HTML. The user wants written content first, not a designed page.',
  '',
  '## Writing rules',
