...
export const slidesCommand: CommandDef = {
  ...
  options: [
    ...
    { name: 'out', value: 'path', description: 'apply: write here instead of in place' },
    {
      name: 'force',
      description:
        'apply: overwrite an existing --out file, or write while Nawa has the file open',
    },
    {
      name: 'page',
      value: 'n',
...
/** One PNG per slide, through the app's PDF export (hidden Nawa process) and pdfium. */
