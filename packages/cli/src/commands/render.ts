...
export const renderCommand: CommandDef = {
  name: 'render',
  summary:
    'One PNG per page of a document, as the Nawa renderer lays it out: the picture an agent looks at to check a Word document, a workbook or a page it just made.',
  usage:
