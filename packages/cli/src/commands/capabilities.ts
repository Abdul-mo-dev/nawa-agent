...
/**
 * What the cloud commands can do on this machine, decided from Nawa's
...
export const capabilitiesCommand: CommandDef = {
  name: 'capabilities',
  summary:
    'Report which cloud features (search, image search, image generation, media analysis) are configured in Nawa, and whether the app is installed.',
  usage: 'capabilities',
  async run(_args, ctx) {
