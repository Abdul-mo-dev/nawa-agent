...
/**
 * Installing the bundled skill into the coding agents found on this
...
/** app-settings.json key under which every install this machine's Nawa wrote is remembered */
