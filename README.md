<p align="center">
  <a href="https://genoffice.ai/">
    <picture>
      ...
      <img src="docs/assets/readme/hero.webp" alt="Nawa — the open-source AI Office suite: Docs, Sheets, Slides, PDF, Markdown and HTML with a built-in AI panel" width="100%">
    </picture>
  </a>
</p>

<h1 align="center">Nawa</h1>

<p align="center"><b>An open-source AI Office suite, forked from GenOffice.</b><br>
...
Nawa is a free, open-source alternative to Microsoft Office for macOS,
Windows and Linux, forked from GenOffice. It opens and saves native `.docx`, `.xlsx` and `.pptx`
